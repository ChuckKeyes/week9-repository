...
output "instance_external_ip" {
  value       = "http://${google_compute_instance.africa.network_interface[0].access_config[0].nat_ip}"
  description = "The external IP address of the GCE instance."
}

output "instance_1external_ip" {
  value       = "http://${google_compute_instance.maryland.network_interface[0].access_config[0].nat_ip}"
  description = "The external IP address of the GCE instance."
}

output "instance_2external_ip" {
  value       = "http://${google_compute_instance.rio.network_interface[0].access_config[0].nat_ip}"
  description = "The external IP address of the GCE instance."
}

output "instance_3external_ip" {
  value       = "http://${google_compute_instance.santiago.network_interface[0].access_config[0].nat_ip}"
  description = "The external IP address of the GCE instance."
}
